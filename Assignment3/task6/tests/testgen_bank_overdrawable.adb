...
-- * Modifications should be made in the corresponding script file.
  ...
  -- File:       /home/andre/Programming/ada/Assignment3/task6/tests/testgen_bank_overdrawable.adb
  -- Script:     /home/andre/Programming/ada/Assignment3/task6/tests/testgen_bank_overdrawable.ts
...
procedure testgen_bank_overdrawable is
...
begin  -- unit main block
  ...
  -- Test Case (1)   Init new Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(1)  Init new Overdrawable Account");
    begin  -- test part
      null;
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:8 ");
          Put_Line ("      ...FAIL.");
  ...
  -- Test Case (2)   Test Deposit on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(2)  Test Deposit on Overdrawable Account");
    begin  -- test part
      Deposit(Account, 10);
      Driver_Internals.Set_Path ("=>");
    exception
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:13 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (3)   Test Deposit Multiple on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(3)  Test Deposit Multiple on Overdrawable Account");
    begin  -- test part
      Deposit(Account, 10);
      Deposit(Account, 35);
      Driver_Internals.Set_Path ("=>");
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:18 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (4)   Test Deposit Negative on Overdrawable Account
  declare
    Account : Overdrawable_Type;
    Except : Boolean := False;
  begin  -- test case
    Put_Line ("(4)  Test Deposit Negative on Overdrawable Account");
    begin  -- test part
      begin
          Deposit(Account,-10);
      exception
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:24 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (5)   Test Withdraw on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(5)  Test Withdraw on Overdrawable Account");
    begin  -- prepare part
      Deposit(Account, 30);
    exception
      when Driver_Internals.Program_Terminate =>
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:35 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (6)   Test Withdraw with overdraw on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(6)  Test Withdraw with overdraw on Overdrawable Account");
    begin  -- test part
      Withdraw(Account, 30);
      Driver_Internals.Set_Path ("=>");
    exception
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:41 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (7)   Test Withdraw with overdraw and positive balance on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(7)  Test Withdraw with overdraw and positive balance on Overdrawable Account");
    begin  -- prepare part
      Deposit(Account, 50);
    exception
      when Driver_Internals.Program_Terminate =>
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:46 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (8)   Test Withdraw with overdraw and negative balance on Overdrawable Account
  declare
    Account : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(8)  Test Withdraw with overdraw and negative balance on Overdrawable Account");
    begin  -- prepare part
      Withdraw(Account, 50);
    exception
      when Driver_Internals.Program_Terminate =>
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:52 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (9)   Test Withdraw on Overdraw Limit on Overdrawable Account
  declare
    Account : Overdrawable_Type;
    Except : Boolean := False;
  begin  -- test case
    Put_Line ("(9)  Test Withdraw on Overdraw Limit on Overdrawable Account");
    begin  -- test part
      begin
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:58 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (10)   Test Withdraw with negative amount on Overdrawable Account
  declare
    Account : Overdrawable_Type;
    Except : Boolean := False;
  begin  -- test case
    Put_Line ("(10)  Test Withdraw with negative amount on Overdrawable Account");
    begin  -- test part
      begin
          Withdraw(Account, -20);
      exception
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:69 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (11)   Test Transfer from Overdrawable Account to Normal Account
  declare
    Account_1 : Overdrawable_Type;
    Account_2 : Account_Type;
  begin  -- test case
    Put_Line ("(11)  Test Transfer from Overdrawable Account to Normal Account");
    begin  -- test part
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:80 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (12)   Test Transfer from Overdrawable Account to Overdrawable Account
  declare
    Account_1 : Overdrawable_Type;
    Account_2 : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(12)  Test Transfer from Overdrawable Account to Overdrawable Account");
    begin  -- test part
      Transfer(Account_1, Account_2, 20);
      Driver_Internals.Set_Path ("=>");
    exception
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:87 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (13)   Test Transfer from Normal Account to Overdrawable Account
  declare
    Account_1 : Account_Type;
    Account_2 : Overdrawable_Type;
  begin  -- test case
    Put_Line ("(13)  Test Transfer from Normal Account to Overdrawable Account");
    begin  -- prepare part
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:94 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (14)   Test Transfer from Normal Account to Overdrawable Account with 0 Balance
  declare
    Account_1 : Account_Type;
    Account_2 : Overdrawable_Type;
    Except : Boolean := False;
  begin  -- test case
    Put_Line ("(14)  Test Transfer from Normal Account to Overdrawable Account with 0 Balance");
    begin  -- test part
      begin
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:102 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  -- Test Case (15)   Test Transfer from Overdrawable Account at the limit
  declare
    Account_1 : Overdrawable_Type;
    Account_2 : Overdrawable_Type;
    Except : Boolean := False;
  begin  -- test case
    Put_Line ("(15)  Test Transfer from Overdrawable Account at the limit");
    begin  -- prepare part
      Withdraw(Account_1, Overdraw_Limit);
    exception
      when Driver_Internals.Program_Terminate =>
        raise;
      when E: others =>
    ...
    begin  -- result part
      if Driver_Internals.Path_Was ("=>") then
        ...
        then
          ...
          Driver_Internals.Test_Case_Passed := False;
          Driver_Internals.Fail_Result := True;
          Put_Line ("           Script name:'testgen_bank_overdrawable.ts'; Line:115 ");
          Put_Line ("      ...FAIL.");
          Put_Line ("         (" & "path `=>' was taken, but predicate is FALSE" & ")");
        end if;
      else
  ...
  --  End of test cases
  New_Line;
  Put ("Script name 'testgen_bank_overdrawable.ts'");
