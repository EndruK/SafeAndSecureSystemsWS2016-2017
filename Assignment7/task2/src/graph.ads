...
package Graph is
    ...
    procedure Add_Edge(G: in out Graph_Type; Edge: Edge_Type);
    ...
    function Has_Vertex(G: Graph_Type; Vertex : Vertex_Type) return Boolean;
    -- Returns True if a vertex is stored in the graph
    -- Returns False otherwise
