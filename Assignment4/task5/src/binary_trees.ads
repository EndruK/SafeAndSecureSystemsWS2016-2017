...
package Binary_Trees is
    ...
    Binary_Tree_Empty_Exception: exception;
    ...
    function Find_Right_Minimum(Subtree: Binary_Tree_Access) return Binary_Tree_Access;
    function Find_To_Delete(T: Binary_Tree_Access;
                            Item: Item_Type) return Binary_Tree_Access;
